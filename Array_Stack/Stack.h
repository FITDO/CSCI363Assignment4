...
public:
  ...
  /**
   * Return and remove the top-most element from the stack.
   * If there are no element on the stack, then the 
   * stack_is_empty exception is thrown.
   *
...
private:
  // elements are placed on the array
  Array<T> * stack_;

  // keeps track of the next possible location for elements
  size_t top_;
};
